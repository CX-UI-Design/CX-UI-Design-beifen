<template>
  <div class='tabs-view'>
    <router-link class="tabs-view-container" v-for="tag in Array.from(visitedViews)" :to="tag.path" :key="tag.path">
...
<style rel="stylesheet/scss" lang="scss" scoped>
  ...
  @media screen and (min-width: 1250px) and (max-width: 1349px) {
    ...
    .tabs-view a.tabs-view:nth-child(n+2) {
      display: inline-block;
    }
  }
  ...
  @media screen and (min-width: 1150px) and (max-width: 1249px) {
    ...
    .tabs-view a.tabs-view:nth-child(n+3) {
      display: inline-block;
    }
  }
  ...
  @media screen and (min-width: 1050px) and (max-width: 1149px) {
    ...
    .tabs-view a.tabs-view:nth-child(n+4) {
      display: inline-block;
    }
  }
  ...
  @media screen and (min-width: 900px) and (max-width: 1049px) {
    ...
    .tabs-view a.tabs-view:nth-child(n+5) {
      display: inline-block;
    }
  }
  ...
  @media screen and (min-width: 800px) and (max-width: 899px) {
    ...
    .tabs-view a.tabs-view:nth-child(n+6) {
      display: inline-block;
    }
  }
