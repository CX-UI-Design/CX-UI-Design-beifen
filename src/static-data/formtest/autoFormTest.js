		...
		"resultData": {
			...
			"fields": [
				...
				//证件号码 - input
				{
					...
					"resourcefieldNameEn": "ownerCertificate", //表单model字段名称
				...
				{
					"resourcefieldXtype": "input", //表单类型
					"resourcefieldNameEn": "ownerMobile", //表单model字段名称
				...
				{
					"resourcefieldXtype": "span", //表单类型
					"resourcefieldNameEn": "tenant", //表单model字段名称
					"resourcefieldName": "lesseeName", //表单字段 lable 名称
					"funcinfoFormlabelwidth": 150, //表单字段 lable 宽度
					"isfieldRequired": false, //是否必填 required
					"resourcefieldBinding": null, //必填出错 提示信息
					"resourcefieldAllowblankexp": null, //内容验证规则
				...
				{
					"resourcefieldXtype": "span", //表单类型
					"resourcefieldNameEn": "createTime", //表单model字段名称
				...
				{
					"resourcefieldXtype": "span", //表单类型
					"resourcefieldNameEn": "createUserName", //表单model字段名称
				...
				{
					"resourcefieldXtype": "span", //表单类型
					"resourcefieldNameEn": "updateTime", //表单model字段名称
				...
				{
					"resourcefieldXtype": "span", //表单类型
					"resourcefieldNameEn": "updateUserName", //表单model字段名称
